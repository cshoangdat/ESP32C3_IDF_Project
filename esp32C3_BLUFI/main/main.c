...
#define WIFI_CONNECTION_MAXIMUM_RETRY           30
#define INVALID_REASON                          255
#define INVALID_RSSI                            -128 //Lỗi chất lượng tín hiệu
...
static void event_callback(esp_blufi_cb_event_t event, esp_blufi_cb_param_t *param)
{
    ...
    case ESP_BLUFI_EVENT_RECV_CUSTOM_DATA:
        ...
        esp_log_buffer_char("Data", param->custom_data.data, param->custom_data.data_len);
        break;
    default:
        break;
    }
